...
// AUTO-GENERATED BY POCKET-IC-BINDGEN DO NOT EDIT
...
pub struct EmrRegistryPocketIc(pub ic_principal::Principal);
impl EmrRegistryPocketIc {
    pub async fn update_emr(
        &self,
