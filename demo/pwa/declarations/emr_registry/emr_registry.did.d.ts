...
export interface CreateEmrResponse {
  header: Header;
}
...
export interface RemoveEmrRequest {
  header: Header;
}
export interface RemoveEmrResponse {
  status: boolean;
}
...
export interface _SERVICE {
  ...
  remove_authorized_caller: ActorMethod<[AuthorizedCallerRequest], undefined>;
