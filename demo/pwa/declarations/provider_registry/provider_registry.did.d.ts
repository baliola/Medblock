...
export interface AuthorizedCallerRequest {
  caller: Principal;
}
...
export interface EmrListProviderRequest {
  page: bigint;
  limit: number;
}
export interface EmrListProviderResponse {
  ids: Array<string>;
}
...
export interface GetProviderBatchRequest {
  ids: Array<string>;
}
export interface GetProviderBatchResponse {
...
export interface IssueEmrResponse {
  emr_header: Header;
}
...
export type Status = { Active: null } | { Suspended: null };
...
export interface _SERVICE {
  ...
  update_patient_registry_principal: ActorMethod<[SuspendRequest], undefined>;
}
