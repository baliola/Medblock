...
export interface ClaimConsentResponse {
  session_id: string;
}
...
export interface EmrListPatientResponse {
  emrs: Array<EmrHeader>;
}
...
export interface ReadEmrByIdResponse {
  emr: EmrHeaderWithBody;
}
...
export interface UpdateEmrRegistryRequest {
  principal: Principal;
}
export interface UpdateInformationRequest {
  metrics: [] | [CollectMetricsRequestType];
}
export interface UpdateInitialPatientInfoRequest {
  info: V1;
}
export interface V1 {
